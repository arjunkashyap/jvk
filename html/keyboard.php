<div id="kbd">
				...
				<div class="keys lline" id="e" onclick="InsertText('ए')">ए</div>
				<div class="keys" id="ai" onclick="InsertText('ऐ')">ऐ</div>
				<div class="keys" id="chandra_o" onclick="InsertText('ऑ')">ऑ</div>
				...
				<div class="keys tline" id="rra" onclick="InsertText('ऱ')">ऱ</div>
				...
				<div class="keys lline" id="sa" style="border-bottom: none;" onclick="InsertText('स')">स</div>
				<div class="keys" id="ha" style="border-bottom: none;" onclick="InsertText('ह')">ह</div>
				<div class="keys" id="La" style="border-bottom: none;" onclick="InsertText('ळ')">ळ</div>
				<div class="keys lline tline" style="clear: left;" id="Akara" onclick="InsertText('ा')">ा</div>
				<div class="keys tline" id="ikara" onclick="InsertText('ि')">ि</div>
				...
				<div class="keys tline" id="Rkara" onclick="InsertText('ृ')">ृ</div>
				<div class="keys tline" id="ekara" onclick="InsertText('े')">े</div>
				<div class="keys lline" id="aikara" onclick="InsertText('ै')">ै</div>
